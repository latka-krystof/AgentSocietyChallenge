...
if __name__ == "__main__":
    ...
    outputs = simulator.run_simulation(number_of_tasks=100, enable_threading=True, max_workers=5)
    
    # Save individual simulation outputs (reviews generated by agent)
    with open(f'./simulation_outputs_track1_{task_set}.json', 'w') as f:
        json.dump(outputs, f, indent=4)
    print(f"\n✅ Individual simulation outputs saved to: ./simulation_outputs_track1_{task_set}.json")
    ...
    print(f"✅ Evaluation results saved to: ./evaluation_results_track1_{task_set}.json")
